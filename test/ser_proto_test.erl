...
parse_cmd_u_1_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("24393_4 Uc0,8,18,101 0003e30c-c50c00f7-123e8bd9-542f2edf@192.168.0.100 192.0.43.10 27686 0003e30cc50cd69210b8c36b-0ecf0120;1")).
...
parse_cmd_u_2_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Uc8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.0.43.9 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_3_1_transcode_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Uc8,0,2,4,18,96,97,98,100,101t4 e12ea248-94a5e885@192.168.5.3 192.0.43.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_3_2_transcode_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4c8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.0.43.5 16432 6b0a8f6cfc543db1o1;1")).

%parse_cmd_u_3_3_transcode_incompatible_test() ->
%	?assertThrow(
%		{error_syntax,"Requested transcoding to incompatible codec"},
%		ser_proto:parse("438_41061 Ut5c8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.168.5.3 16432 6b0a8f6cfc543db1o1;1")).
parse_cmd_u_3_3_transcode_incompatible_test() ->
	?assertEqual(
		#cmd{
			type=?CMD_U,
...
%		ser_proto:parse("438_41061 Ut1 e12ea248-94a5e885@192.168.5.3 192.168.5.3 16432 6b0a8f6cfc543db1o1;1")).
parse_cmd_u_3_4_transcode_no_codecs_test() ->
	?assertEqual(
		#cmd{
			type=?CMD_U,
...
parse_cmd_u_4_zeroes_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("5958_7 UZ30" ++ [0,0,0] ++ "c34,31 ffe0100519df4bc1bbd2f8e18309ca8a 192.0.43.7 19268 186f101b0e04481ea045517edb93b62d;2")).
...
parse_cmd_u_5_proto_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1c8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.0.43.4 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_6_0_internal_to_internal_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1iic8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.168.5.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_6_1_internal_to_external_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1iec8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.168.5.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_6_2_external_to_internal_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1eic8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.0.43.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_6_3_external_to_external_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1eec8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.0.43.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_6_4_internal_to_internal_single_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1ic8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.168.5.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_6_5_external_to_external_single_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1ec8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.0.43.3 16432 6b0a8f6cfc543db1o1;1")).

parse_cmd_u_7_both_symmetric_and_asymmetric_test() ->
	?assertThrow(
		{error_syntax,"Both symmetric and asymmetric modifiers are defined"},
		ser_proto:parse("438_41061 Ut4p1asc8,0,2,4,18,96,97,98,100,101 e12ea248-94a5e885@192.168.5.3 192.168.5.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_8_acc_start_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1c8,0,2,4,18,96,97,98,100,101v0 e12ea248-94a5e885@192.168.5.3 192.0.43.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_9_acc_interim_update_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1c8,0,2,4,18,96,97,98,100,101v0v1 e12ea248-94a5e885@192.168.5.3 192.0.43.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_10_acc_stop_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1c8,0,2,4,18,96,97,98,100,101v0v1v2 e12ea248-94a5e885@192.168.5.3 192.0.43.3 16432 6b0a8f6cfc543db1o1;1")).

parse_cmd_u_11_wrong_ipv4_test() ->
	?assertThrow(
		{error_syntax,"Wrong IP"},
		ser_proto:parse("24393_4 Uc0,8,18,101 0003e30c-c50c00f7-123e8bd9-542f2edf@192.168.0.100 892.168.0.100 27686 0003e30cc50cd69210b8c36b-0ecf0120;1")).

parse_cmd_u_12_wrong_port_test() ->
	?assertThrow(
		{error_syntax,"Wrong port"},
		ser_proto:parse("24393_4 Uc0,8,18,101 0003e30c-c50c00f7-123e8bd9-542f2edf@192.168.0.100 192.168.0.100 627686 0003e30cc50cd69210b8c36b-0ecf0120;1")).

parse_cmd_u_13_wrong_mediaid_test() ->
	?assertThrow(
		{error_syntax,"Wrong MediaID"},
		ser_proto:parse("24393_4 Uc0,8,18,101 0003e30c-c50c00f7-123e8bd9-542f2edf@192.168.0.100 192.168.0.100 27686 0003e30cc50cd69210b8c36b-0ecf0120;foo")).
...
parse_cmd_u_14_discard_rfc1918_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1c8,0,2,4,18,96,97,98,100,101v0v1v2 e12ea248-94a5e885@192.168.5.3 192.168.43.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_15_discard_non_rfc1918_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("438_41061 Ut4p1iec8,0,2,4,18,96,97,98,100,101v0v1v2 e12ea248-94a5e885@192.168.5.3 192.0.43.3 16432 6b0a8f6cfc543db1o1;1")).
...
parse_cmd_u_16_ipv6_source_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("9440_4 UwEEt3Z30c9,96,97,0,8,98,3,100,5,6,15,101 e12050ca82cc434c444ae66fcb30a4c0@0:0:0:0:0:0:0:0 2001:500:88:200:0:0:0:10 5000 595f563;1")).
...
parse_cmd_l_1_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("413_40797 Lc0,101,100 452ca314-3bbcf0ea@192.168.0.2 192.0.43.4 17050 e4920d0cb29cf52o0;1 8d11d16a3b56fcd588d72b3d359cc4e1;1")).
...
parse_cmd_r_1_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("393_6 R 0003e348-e21901f6-29cc58a1-379f3ffd@192.168.0.1 0003e348e219767510f1e38f-47c56231")).
...
parse_cmd_r_2_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("32711_5 R 0003e30c-c50c016a-35dc4387-58a65654@192.168.0.100 eb1f1ca7e74cf0fc8a81ea331486452a 0003e30cc50ccbed0342cc8d-0bddf550")).
...
parse_cmd_p_1_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("2154_5 P20 0003e30c-c50c0171-35b90751-013a3ef6@192.168.0.100 /var/run/tmp/hello_uac.wav session 0003e30cc50ccc9f743d4fa6-38d0bd14;1")).
...
parse_cmd_p_2_test() ->
	?assertEqual(
		...
		}, ser_proto:parse("1389_5 P10 0003e30c-c50c016d-46bbcf2e-6369eecf@192.168.0.100 /var/tmp/rtpproxy_test/media/01.wav session 0003e30cc50ccc5416857d59-357336dc;1 28d49e51a95d5a31d09b31ccc63c5f4b;1")).

parse_cmd_p_3_wrong_playcount_test() ->
	?assertThrow(
		{error_syntax,"Wrong PlayCount"},
		ser_proto:parse("1389_5 Phello 0003e30c-c50c016d-46bbcf2e-6369eecf@192.168.0.100 /var/tmp/rtpproxy_test/media/01.wav session 0003e30cc50ccc5416857d59-357336dc;1 28d49e51a95d5a31d09b31ccc63c5f4b;1")).
...
parse_cmd_s_1_test() ->
	?assertEqual(
		#cmd{
			...
			mediaid=1,
			from=#party{tag="0003e30cc50ccc9f743d4fa6-38d0bd14"}
		}, ser_proto:parse("2154_6 S 0003e30c-c50c0171-35b90751-013a3ef6@192.168.0.100 0003e30cc50ccc9f743d4fa6-38d0bd14;1")).

parse_cmd_unknown_test() ->
	?assertThrow(
		{error_syntax,"Unknown command"},
		ser_proto:parse("2154_6 Z 0003e30c-c50c0171-35b90751-013a3ef6@192.168.0.100 0003e30cc50ccc9f743d4fa6-38d0bd14;1")).

parse_reply_ipv4_test() ->
	?assertEqual(
		#response{cookie="8411_41413", type = reply, data = {{{192,168,100,4},41212}, {{192,168,100,4},41213}}},
		ser_proto:parse("8411_41413 41212 192.168.100.4")).
...
parse_reply_ipv6_test() ->
	?assertEqual(
		...
		ser_proto:parse("8411_41413 41212 2001:500:88:200::10")).
