...
-export([start_link/1, find/2, find_or_open/2, info/2, list/1, select/2, setattr/3, setattr/4, getattr/3, getattr/4, increment/4,delattr/3]).
-export([wait/1]).
...
terminate_child(Zone, Name) ->
	error_logger:error_msg("TERMINATE ~p: ~p~n", [Zone, Name]),
  gen_server:call(Zone, {terminate_child, Name}).
