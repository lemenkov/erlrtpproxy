...
handle_cast({message_u, UnixPid, {Ip, Port}, {CallId, OrigIp, OrigPort, FromTag, MediaId}}, {Fd, CallsList}) ->
...
handle_cast({message_l, UnixPid, {Ip, Port}, {CallId, OrigIp, OrigPort, FromTag, MediaIdFrom, ToTag, MediaIdTo}}, {Fd, CallsList}) ->
...
handle_info({udp, Fd, Ip, Port, Msg}, State) ->
	case string:tokens(Msg, " ;") of
		...
		[UnixPid, "U", CallId, OrigIp, OrigPort, FromTag, MediaId] ->
			ok = gen_server:cast({global, rtpproxy}, {message_u, UnixPid, {Ip, Port}, {CallId, OrigIp, OrigPort, FromTag, MediaId}});
		[UnixPid, "L", CallId, OrigIp, OrigPort, FromTag, MediaIdFrom, ToTag, MediaIdTo] ->
			ok = gen_server:cast({global, rtpproxy}, {message_l, UnixPid, {Ip, Port}, {CallId, OrigIp, OrigPort, FromTag, MediaIdFrom, ToTag, MediaIdTo}});
		_Other ->
